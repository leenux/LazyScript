...
lazyScript.PopAction = {}
function lazyScript.PopAction:New(code, message)
	local obj = {}
	setmetatable(obj, { __index = self })
	obj.name = "pop"
	obj.code = code
...
function lazyScript.PopAction:Use()
	lazyScript.pop(self.message)
	self.everyTimer = GetTime()
	self.nowAndEveryTimer = self.everyTimer
end

lazyScript.PopAction.IsUsable = lazyScript.AlwaysUsable
